<?php
    ...
    $lenghtValue = array_key_exists( 'length-input' , $_GET ) ? $_GET['length-input'] : '' ;
    ...
    $newPassword = generatePassword($lenghtValue,$charCheck,$specialcharCheck,$numCheck);
    
    function generatePassword($lenght,$charCheck,$specialcharCheck,$numCheck){
        $specialArray = ['!','@','#','$','%','^','&','*','(',')','_','-','!','=','?',':','.',';'];
